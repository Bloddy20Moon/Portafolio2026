    ...
    <section className="min-h-[75vh] flex flex-col md:flex-row items-center justify-between gap-gutter pt-20 pb-10 md:pt-24 md:pb-12">
      <div className="flex-1 space-y-stack-lg">
        ...
        <div className="flex flex-wrap gap-2 pt-stack-lg">
          ...
          <span className="tech-tag font-label-mono text-label-mono px-3 py-1 rounded-sm text-xs">ANGULAR</span>
      ...
      <div className="flex-1 w-full max-w-lg mt-12 md:mt-0">
        <div className="glass-panel rounded-xl p-6 shadow-2xl relative overflow-hidden group">
          ...
          <pre className="font-label-mono text-label-mono text-sm leading-relaxed overflow-x-auto text-gray-300">
            ...
            {"  "}stack: [<span className="text-[#a7f3d0]">'React'</span>, <span className="text-[#a7f3d0]">'Node'</span>, <span className="text-[#a7f3d0]">'Angular'</span>,<span className="text-[#a7f3d0]">'Power BI'</span>],{"\n"}
